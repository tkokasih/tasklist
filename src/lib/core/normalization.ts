...
import type { Task, TaskData, TaskSession, TaskStatus } from '$lib/core/taskTypes';
import { cloneDefaultStatusSelection, orderStatuses } from '$lib/core/taskFilters';
 ...
 */
export const normalizeProjects = (projects: TaskData['projects']): TaskData['projects'] =>
...
const sanitizeFilters = (rawStatuses: TaskStatus[] | undefined): TaskStatus[] => {
	if (!rawStatuses) {
