...
describe('time formatting helpers', () => {
	...
	describe('formatTimestamp', () => {
		...
		it('formats valid iso timestamps using locale formatting', () => {
			const spy = vi.spyOn(Date.prototype, 'toLocaleString').mockReturnValue('Mock Locale Time');

			expect(formatTimestamp('2024-01-01T10:00:00.000Z')).toBe('Mock Locale Time');
