...
- [ ] **Iteration 1 – Aggregation API** — _In progress (updated October 21, 2025)._
  ...
  - _Progress to date (October 21, 2025)_
...
- [ ] **Iteration 2 – Store Integration** — _Planned._
...
- [ ] **Iteration 5 – Exports & Summary Cards** — _Planned._
