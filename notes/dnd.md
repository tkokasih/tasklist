...
### Option A – Handle + Horizontal Thresholds _(Recommended)_
...
Adopt **Option A**. It keeps the interaction fluid, aligns with user expectations for modern outliners, and keeps the hierarchy change inside the same gesture. Employ generous thresholds, visual badges (“↳ Nest under _Task A_”) and undo support to mitigate misdrops.
